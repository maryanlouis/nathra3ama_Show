...
class Data {
  ...
  Data({required this.vedios, required this.categories});
...
class myvedios {
  ...
  myvedios({required this.vedio_title,
    required this.vedio_id,
    required this.vedio_category,
    required this.serial,
    required this.vedio_description,
    //required this.links
  });
      //this.resource_title
...
class resource_link {
  ...
  int vedio_serial;
  resource_link({required this.link, required this.resource_title, required this.vedio_serial});
...
class mycategories {
  ...
  mycategories({required this.category_id,required this.category_title});
